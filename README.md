...
THERE IS A SCENARIO WHERE THE MERGERFS METHOD IS STILL BENEFICIAL DURING THE PLOTTING PHASE, WHEN BANDWITH LIMITATIONS PER DISK SLOWS DOWN COPYING OF PLOTS. READ IN SECTION
