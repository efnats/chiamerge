...
FOR THAT REASON I'M MOVING AWAY FROM MERGERFS. I WILL FOCUS ON IMPROVING DISK PREPARATION USING THE CHIAMERGE TOOL AND MOUNTING SERVICES AND HAVE PROVIDED YOU WITH A TOOL TO AUTOMATICALLY SET THE CORRECT SEPERATE DISKS IN YOUR DOCKER-COMPOSE FILE (FOR MACHINARIS). SEE **Exportdrives Script** DOWN BELOW.

THERE IS A SCENARIO WHERE THE MERGERFS METHOD IS STILL BENEFICIAL DURING THE PLOTTING PHASE, WHEN BANDWITH LIMITATIONS PER DISK SLOWS DOWN COPYING OF PLOTS. READ IN SECTION **mnt-garden.mount** FOR MORE INFO ON THAT.
