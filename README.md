...
FOR THAT REASON I'M MOVING AWAY FROM MERGERFS. I WILL FOCUS ON IMPROVING DISK PREPARATION USING THE CHIAMERGE TOOL AND MOUNTING SERVICES AND HAVE PROVIDED YOU WITH A TOOL TO AUTOMATICALLY SET THE CORRECT SEPERATE DISKS IN YOUR DOCKER-COMPOSE FILE (FOR MACHINARIS). SEE **createenv script** DOWN BELOW.
